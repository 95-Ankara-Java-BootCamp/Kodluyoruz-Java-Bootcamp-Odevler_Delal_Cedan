...
import ThirdWeek.model.Ucak;
import ThirdWeek.service.abstracts.BaseRezervasyonService;
import ThirdWeek.service.concretes.PegasusRezervasyon;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ucak.setKalkisZamani(LocalDateTime.of(2021, 7,16,13, 0));
